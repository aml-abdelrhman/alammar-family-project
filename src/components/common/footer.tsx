...
export const FullPageFooter = () => {
  return (
    <section className="relative w-full bg-[#F5EFE5] text-[#3A2A1E] overflow-hidden rounded-b-[32px]">
      ...
      <div 
        className="relative z-10 flex flex-col items-center justify-center w-full pb-16 mx-auto lg:flex-row lg:items-start lg:pb-0 min-h-0 lg:min-h-[490px]"
        style={{
          maxWidth: "1440px",
      ...
      >
        ...
        >
          ...
          {/* تم استخدام pb-6 للجوال ليلتصق بالمحتوى و lg:pb-0 للاب والتابلت ليعود لوضعه الأصلي */}
          <div className="flex flex-col items-center w-full mt-8 pb-15 lg:pb-0 lg:mt-18">
            <div className="flex items-center justify-center w-full max-w-[418px] mx-auto px-4 mb-1" style={{ gap: "6px" }}>
              <div
