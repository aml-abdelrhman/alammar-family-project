  ...
  return (
    <>
      <section className="relative flex flex-col justify-between items-end w-full max-w-[1550px] mx-auto overflow-hidden px-6 sm:px-10 lg:px-[80px] pt-7 pb-[70px] min-h-[905px] md:min-h-screen lg:min-h-[1020px]">
        ...
        <div
          className="relative z-10 flex flex-col justify-end lg:justify-center items-start w-full max-w-[1280px] mx-auto my-auto pb-10 sm:pb-20 lg:pb-0 pt-12 sm:pt-28 lg:pt-0 gap-6 md:gap-12 lg:gap-[48px] min-h-[520px] sm:min-h-[600px] md:min-h-[700px] lg:min-h-[739px]"
        >
